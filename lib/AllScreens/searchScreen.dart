                ...
                children: [
                  ...
                  Stack(
                    children: [
                      ...
                      Center(
                        child: Text("Search Parking Place", style: TextStyle(fontSize: 18.0, fontFamily: "Brand Bold"),),
                      ),
                    ],
                  ),
...
class PredictionTile extends StatelessWidget 
{
  ...
  void getPlaceAddressDetails(String placeId, context) async
  {
    showDialog(
      context: context,
      builder: (BuildContext context) => ProgressDialog(message: "Setting Parking, Please wait...",)
    );
