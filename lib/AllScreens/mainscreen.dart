...
import '../AllScreens/profileTabPage.dart';
import '../AllScreens/ratingScreen.dart';
import '../AllScreens/registerationScreen.dart';
import '../AllScreens/searchScreen.dart';
...
class _MainScreenState extends State<MainScreen> with TickerProviderStateMixin
{
  ...
  void updateRideTimeToPickUpLoc(LatLng driverCurrentLocation) async
  {
    if(isRequestingPositionDetails == false)
    {
      ...
      setState(() {
        rideStatus = "You can reach the parking in " + details.durationText;
      });
  ...
  void displayRideDetailsContainer() async
  {
    ...
    setState(() {
      ...
      rideDetailsContainerHeight = 110.0;
      bottomPaddingOfMap = 140.0;
      drawerOpen = false;
    });
  }
                    ...
                    children: [
                     ...
                     /* GestureDetector(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                Text(
                                  ((tripDirectionDetails != null) ? '\$5/h' : ''), style: TextStyle(fontFamily: "Brand Bold",),
                                ),
                                // Text(
                      ...
                      GestureDetector(
                        onTap: ()
                        {
                          displayToastMessage("searching parking...", context);
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: Text(
                                        ((tripDirectionDetails != null) ? tripDirectionDetails.distanceText : '') , style: TextStyle(fontSize: 16.0, color: Colors.black,),
                                      ),
                                    ),
                                    SizedBox(width: 20,),
                                    Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    Text(
                                      "Lorry", style: TextStyle(fontSize: 18.0, fontFamily: "Brand Bold",),
                                    ),
                                    Text(
                                      ((tripDirectionDetails != null) ? tripDirectionDetails.distanceText : '') , style: TextStyle(fontSize: 16.0, color: Colors.grey,),
                                    ),
                                ...
                                Expanded(child: Container()),
                                Text(
                                  ((tripDirectionDetails != null) ? '\$25/h' : ''), style: TextStyle(fontFamily: "Brand Bold",),
                                ),
                              ],
                            ),
                          ),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Text('Your park owner is ', style: TextStyle(fontSize: 20.0),),
                          ...
                          child: RaisedButton(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                children: [
                                  Text("Call Park Owner   ", style: TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold, color: Colors.white),),
